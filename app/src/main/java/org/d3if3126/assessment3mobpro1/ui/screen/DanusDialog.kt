...
@Composable
fun DanusDialog(bitmap: Bitmap?,onDismissRequest: ()->Unit, onConfirmation:(String,String)->Unit) {
    ...
    Dialog(onDismissRequest = {
        ...
        Card(modifier = Modifier.padding(16.dp), shape = RoundedCornerShape(16.dp)) {
            Column(modifier = Modifier.padding(16.dp), horizontalAlignment = Alignment.CenterHorizontally){
                ...
                OutlinedTextField(value = posisi, onValueChange = {
                    posisi = it
                }, label = {
                    Text(text = stringResource(id = R.string.daerah))
                },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                Row(modifier = Modifier
                    ...
                    OutlinedButton(onClick = { onConfirmation(nama,posisi) }, enabled = nama.isNotEmpty() && posisi.isNotEmpty(), modifier = Modifier.padding(8.dp)) {
